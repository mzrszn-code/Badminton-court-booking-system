...
@section('content')
    <div class="page-header" style="text-align: center; margin-bottom: 3rem;">
        <h1 class="page-title" style="font-size: 2.5rem;">About Flotilla Badminton Center</h1>
    ...
    <div class="grid grid-cols-2" style="gap: 2rem; margin-bottom: 3rem;">
        ...
        <div class="card">
            <div style="text-align: center; padding: 1rem;">
                <div
                    style="width: 80px; height: 80px; background: var(--gradient-primary); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem;">
        ...
        <div class="card">
            <div style="text-align: center; padding: 1rem;">
                <div
                    style="width: 80px; height: 80px; background: var(--gradient-secondary); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem;">
    ...
    <div class="card" style="margin-bottom: 3rem;">
        ...
        <div class="grid grid-cols-3" style="gap: 2rem;">
            <div style="text-align: center;">
                <div
                    style="width: 60px; height: 60px; background: var(--gradient-success); border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center; margin: 0 auto 1rem;">
                    <i class="fas fa-clock" style="font-size: 1.5rem; color: white;"></i>
                </div>
                <h3 style="font-weight: 600; margin-bottom: 0.5rem;">Easy Booking</h3>
                <p style="color: var(--text-secondary); font-size: 0.875rem;">Book your preferred court in just a few
                    clicks, anytime, anywhere.</p>
            </div>

            <div style="text-align: center;">
                <div
                    style="width: 60px; height: 60px; background: var(--gradient-accent); border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center; margin: 0 auto 1rem;">
                ...
                <p style="color: var(--text-secondary); font-size: 0.875rem;">Safe and verified payment process with admin
                    confirmation.</p>
            </div>

            <div style="text-align: center;">
                <div
                    style="width: 60px; height: 60px; background: var(--gradient-primary); border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center; margin: 0 auto 1rem;">
                    <i class="fas fa-qrcode" style="font-size: 1.5rem; color: white;"></i>
                </div>
                <h3 style="font-weight: 600; margin-bottom: 0.5rem;">QR Check-In</h3>
                <p style="color: var(--text-secondary); font-size: 0.875rem;">Quick and contactless check-in with your
                    unique QR code.</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2" style="gap: 2rem;">
        ...
        <div class="card">
            ...
            <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                ...
                <div style="display: flex; align-items: center; gap: 1rem;">
                    <div
                        style="width: 50px; height: 50px; background: rgba(239, 68, 68, 0.15); border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center;">
                        <i class="fas fa-envelope" style="font-size: 1.25rem; color: #ef4444;"></i>
                    </div>
                    <div>
                        <h4 style="font-weight: 600; margin-bottom: 0.25rem;">Email</h4>
                        <p style="color: var(--text-secondary); font-size: 0.875rem;">flotillabadmintoncenter@iium.edu.my
                        </p>
                    </div>
                </div>
                ...
                <div style="display: flex; align-items: center; gap: 1rem;">
                    <div
                        style="width: 50px; height: 50px; background: rgba(99, 102, 241, 0.15); border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center;">
                ...
                <div style="display: flex; align-items: center; gap: 1rem;">
                    <div
                        style="width: 50px; height: 50px; background: rgba(16, 185, 129, 0.15); border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center;">
        ...
        <div class="card">
            ...
            <div style="display: flex; align-items: flex-start; gap: 1rem; margin-bottom: 1.5rem;">
                <div
                    style="width: 40px; height: 40px; background: rgba(99, 102, 241, 0.15); border-radius: var(--radius-sm); display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                    <i class="fas fa-building" style="color: var(--primary);"></i>
                </div>
                <div>
                    <h4 style="font-weight: 600; margin-bottom: 0.25rem;">Flotilla Badminton Center</h4>
            ...
            <a href="https://maps.app.goo.gl/21522vVu4y6msyE39" target="_blank" class="btn btn-primary"
    ...
    <!-- Team Section -->
    <div class="card" style="margin-bottom: 1.5rem; margin-top: 3rem;">
        <h2 class="card-title" style="text-align: center; margin-bottom: 2rem;">
        ...
        <div class="team-grid">
            <div class="team-member">
                <div class="team-avatar">
                    <img src="{{ asset('images/team/wazir.jpg') }}" alt="Wazir">
                </div>
                <h4 style="font-weight: 600; margin-bottom: 0.25rem;">Wazir</h4>
                <p style="color: var(--text-muted); font-size: 0.75rem;">2215353</p>
            </div>

            <div class="team-member">
                <div class="team-avatar">
                    <img src="{{ asset('images/team/zafri.jpg') }}" alt="Zafri">
                </div>
                <h4 style="font-weight: 600; margin-bottom: 0.25rem;">Zafri</h4>
                <p style="color: var(--text-muted); font-size: 0.75rem;">2319855</p>
            </div>

            <div class="team-member">
                <div class="team-avatar">
                    <img src="{{ asset('images/team/budin.jpg') }}" alt="Budin">
                </div>
            ...
            <div class="team-member">
                <div class="team-avatar">
                    <img src="{{ asset('images/team/izwan.jpg') }}" alt="Izwan">
                </div>
                <h4 style="font-weight: 600; margin-bottom: 0.25rem;">Izwan</h4>
                <p style="color: var(--text-muted); font-size: 0.75rem;">2316037</p>
            </div>

            <div class="team-member">
                <div class="team-avatar">
                    <img src="{{ asset('images/team/muaz.jpg') }}" alt="Muaz">
                </div>
                <h4 style="font-weight: 600; margin-bottom: 0.25rem;">Muaz</h4>
                <p style="color: var(--text-muted); font-size: 0.75rem;">2317805</p>
            </div>
        </div>
    </div>
@endsection