...
<div style="margin-bottom: 1rem;">
    <a href="{{ route('bookings.show', $booking) }}" style="color: var(--text-secondary); text-decoration: none; font-size: 0.875rem;">
...
<div class="grid grid-cols-2" style="grid-template-columns: 1fr 400px;">
    ...
    <div>
        ...
        <div class="card" style="margin-bottom: 1.5rem;">
            <div class="card-header">
                <h2 class="card-title"><i class="fas fa-receipt" style="color: var(--primary); margin-right: 0.5rem;"></i> Booking Summary</h2>
            </div>
            ...
            <div style="display: grid; gap: 0.75rem;">
                ...
                <div style="display: flex; justify-content: space-between; padding: 0.75rem; background: var(--bg-card-hover); border-radius: var(--radius-sm);">
                    ...
                    <span style="font-weight: 600;">{{ \Carbon\Carbon::parse($booking->start_time)->format('g:i A') }} - {{ \Carbon\Carbon::parse($booking->end_time)->format('g:i A') }}</span>
                </div>
        ...
        <div class="card">
            <div class="card-header">
                <h2 class="card-title"><i class="fas fa-credit-card" style="color: var(--secondary); margin-right: 0.5rem;"></i> Payment Methods</h2>
            </div>
            
            <div style="display: grid; gap: 1.5rem;">
                <!-- Bank Transfer -->
                <div style="padding: 1.5rem; background: var(--bg-card-hover); border-radius: var(--radius-md); border: 2px solid var(--primary);">
                    ...
                    <div style="display: grid; gap: 0.5rem;">
                        ...
                        <div style="display: flex; justify-content: space-between;">
                            ...
                            <span style="font-weight: 700; font-size: 1.25rem; color: var(--primary); font-family: monospace;">{{ $bankDetails['account_number'] }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div style="padding: 1.5rem; background: var(--bg-card-hover); border-radius: var(--radius-md);">
                    ...
                    <div style="text-align: center;">
                        <div style="background: white; padding: 1rem; border-radius: var(--radius-md); display: inline-block; margin-bottom: 1rem;">
                            <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={{ urlencode('00020101021229370016A000000615000001011011001234567890305' . number_format($total, 2) . '5802MY5925BadmintonBook Sdn Bhd6304') }}" 
                                 alt="DuitNow QR" style="display: block;">
                        </div>
                        <p style="font-size: 0.875rem; color: var(--text-secondary);">Scan this QR code with your banking app</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div>
        ...
        @if(!$booking->payment || $booking->payment->payment_status === 'rejected')
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title"><i class="fas fa-upload" style="color: var(--accent); margin-right: 0.5rem;"></i> Submit Payment Proof</h2>
                </div>
                ...
                <form method="POST" action="{{ route('payments.submit', $booking) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <p style="font-size: 0.75rem; color: var(--text-muted); margin-top: 0.5rem;">Enter your bank transfer reference or transaction ID</p>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <p style="font-size: 0.75rem; color: var(--text-muted); margin-top: 0.5rem;">Upload screenshot of your payment receipt (JPEG, PNG, max 2MB)</p>
                    </div>
        ...
        <div class="card" style="margin-top: 1.5rem;">
            <h3 style="font-weight: 600; margin-bottom: 1rem;"><i class="fas fa-info-circle" style="color: var(--secondary); margin-right: 0.5rem;"></i> Important</h3>
            <ul style="color: var(--text-secondary); font-size: 0.875rem; line-height: 1.8; padding-left: 1.25rem;">
                <li>Make sure to transfer the exact amount: <strong style="color: var(--primary);">RM {{ number_format($total, 2) }}</strong></li>
